...
- Volume dos logs diarios: `../../logs` → `/var/log/nagstamon-headless` (`LOG_DIR`); o arquivo `nagstamon-YYYY-MM-DD.log` e atualizado no host a cada escrita
